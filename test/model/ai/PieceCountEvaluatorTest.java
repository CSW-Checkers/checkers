...
public class PieceCountEvaluatorTest {

    @Test
    public void testEvaluateBoard() {
        Board board = new Board();
        BoardEvaluator eval = new PieceCountEvaluator();

        double epsilon = 0.0;

        double expectedValue = 0.0;
        double actualValue = eval.evaluateBoard(board, PieceColor.BLACK);
        ...
        expectedValue = -2.0;
        actualValue = eval.evaluateBoard(board, PieceColor.BLACK);
        assertEquals(expectedValue, actualValue, epsilon);
