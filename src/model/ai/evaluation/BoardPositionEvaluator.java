...
public class BoardPositionEvaluator implements BoardEvaluatorInterface {
    ...
    private void initializeBlackPositionValueMap() {
        ...
        this.blackPositionValueMap.put(5, 0.0);
        this.blackPositionValueMap.put(6, 0.5);
        this.blackPositionValueMap.put(7, 0.5);
        this.blackPositionValueMap.put(8, 0.5);
        this.blackPositionValueMap.put(9, 1.0);
        this.blackPositionValueMap.put(10, 1.0);
        this.blackPositionValueMap.put(11, 1.0);
        this.blackPositionValueMap.put(12, 0.5);
        this.blackPositionValueMap.put(13, 1.5);
        this.blackPositionValueMap.put(14, 3.0);
        this.blackPositionValueMap.put(15, 3.0);
        this.blackPositionValueMap.put(16, 2.0);
        this.blackPositionValueMap.put(17, 3.0);
        this.blackPositionValueMap.put(18, 3.5);
        this.blackPositionValueMap.put(19, 3.5);
        this.blackPositionValueMap.put(20, 2.5);
        this.blackPositionValueMap.put(21, 3.5);
        ...
        this.blackPositionValueMap.put(28, 4.5);
        this.blackPositionValueMap.put(29, 6.5);
    ...
    private void initializeWhitePositionValueMap() {
        ...
        this.whitePositionValueMap.put(4, 6.5);
        this.whitePositionValueMap.put(5, 4.5);
        ...
        this.whitePositionValueMap.put(12, 3.5);
        this.whitePositionValueMap.put(13, 2.5);
        this.whitePositionValueMap.put(14, 3.5);
        this.whitePositionValueMap.put(15, 3.5);
        this.whitePositionValueMap.put(16, 3.0);
        this.whitePositionValueMap.put(17, 2.0);
        this.whitePositionValueMap.put(18, 3.0);
        this.whitePositionValueMap.put(19, 3.0);
        this.whitePositionValueMap.put(20, 1.5);
        this.whitePositionValueMap.put(21, 0.5);
        this.whitePositionValueMap.put(22, 1.0);
        this.whitePositionValueMap.put(23, 1.0);
        this.whitePositionValueMap.put(24, 1.0);
        this.whitePositionValueMap.put(25, 0.5);
        this.whitePositionValueMap.put(26, 0.5);
        this.whitePositionValueMap.put(27, 0.5);
        this.whitePositionValueMap.put(28, 0.0);
