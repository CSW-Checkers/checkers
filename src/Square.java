...
public class Square {
	...
	final private List<Integer> adjacentSquares;
	...
	{
		List<Integer> NonCenterSquares =  Arrays.asList(1, 2, 3, 4, 5, 12, 13, 20, 21, 28, 29, 30, 31, 32);
	...
	private void kingPieceIfNecessary()
	{
		if ((this.isOnBlackEdgeOfBoard() && occupyingPiece.getColor().equals(PieceColor.WHITE))
				|| (this.isOnWhiteEdgeOfBoard() && occupyingPiece.getColor().equals(PieceColor.BLACK)))
		{
